...
type TableComponent = <T extends Record<string, string | number>>(props: Props<T>) => React.ReactElement;

const cn = classname('table');

export const Table: TableComponent = ({ data, className, columns, footer, includeHead = false }) => {
