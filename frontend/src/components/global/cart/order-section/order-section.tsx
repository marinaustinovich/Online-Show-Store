...
import { createOrderAction, orderFormDataSelector, orderStatusSelector } from 'store/products';
            ...
            <div className='card' style={{ maxWidth: '30rem', margin: '0 auto' }}>
                <form className='card-body' onSubmit={handleSubmit}>
                    ...
                    <FormGroup
                        ...
                        validate={required}
                    />
                    <Checkbox id='agreement' label={t(`${locale}.agreement-label`)} checked={orderFormData.agreement} onChange={handleChange} />
                    <Button className='btn-outline-secondary' type='submit' disabled={!orderFormData.agreement}>
                        {t(`${locale}.design-btn`)}
                    </Button>
                </form>
            </div>
